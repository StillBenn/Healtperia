...
(function (I) {
  ...
  add('tr', {
    ...
    'dd.stat.today': 'Bugünkü Randevu', 'dd.stat.pending': 'Bekleyen Talep', 'dd.stat.total': 'Toplam Hasta', 'dd.stat.rating': 'Değerlendirme',
  ...
  add('en', {
    ...
    'dd.stat.today': 'Today’s Appointments', 'dd.stat.pending': 'Pending Request', 'dd.stat.total': 'Total Patients', 'dd.stat.rating': 'Rating',
  ...
  add('de', {
    ...
    'dd.stat.today': 'Heutige Termine', 'dd.stat.pending': 'Offene Anfrage', 'dd.stat.total': 'Patienten gesamt', 'dd.stat.rating': 'Bewertung',
  ...
  add('ru', {
    ...
    'dd.stat.today': 'Приёмы сегодня', 'dd.stat.pending': 'Ожидающий запрос', 'dd.stat.total': 'Всего пациентов', 'dd.stat.rating': 'Оценка',
  ...
  add('fr', {
    ...
    'dd.stat.today': 'Rendez-vous du jour', 'dd.stat.pending': 'Demande en attente', 'dd.stat.total': 'Total des patients', 'dd.stat.rating': 'Évaluation',
  ...
  add('es', {
    ...
    'dd.stat.today': 'Citas de hoy', 'dd.stat.pending': 'Solicitud pendiente', 'dd.stat.total': 'Total de pacientes', 'dd.stat.rating': 'Valoración',
  ...
  add('pt', {
    ...
    'dd.stat.today': 'Consultas de hoje', 'dd.stat.pending': 'Solicitação pendente', 'dd.stat.total': 'Total de pacientes', 'dd.stat.rating': 'Avaliação',
  ...
  add('ar', {
    ...
    'dd.stat.today': 'مواعيد اليوم', 'dd.stat.pending': 'طلب معلّق', 'dd.stat.total': 'إجمالي المرضى', 'dd.stat.rating': 'التقييم',
  ...
  add('nl', {
    ...
    'dd.stat.today': 'Afspraken vandaag', 'dd.stat.pending': 'Openstaand verzoek', 'dd.stat.total': 'Totaal patiënten', 'dd.stat.rating': 'Beoordeling',

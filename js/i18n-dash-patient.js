...
(function (I) {
  ...
  add('tr', {
    ...
    'dp.stat.upcoming': 'Yaklaşan Randevu', 'dp.stat.unread': 'Okunmamış Mesaj', 'dp.stat.records': 'Tıbbi Kayıt', 'dp.stat.favDoc': 'Favori Doktor',
  ...
  add('en', {
    ...
    'dp.stat.upcoming': 'Upcoming Appointment', 'dp.stat.unread': 'Unread Message', 'dp.stat.records': 'Medical Record', 'dp.stat.favDoc': 'Favorite Doctor',
  ...
  add('de', {
    ...
    'dp.stat.upcoming': 'Anstehender Termin', 'dp.stat.unread': 'Ungelesene Nachricht', 'dp.stat.records': 'Medizinische Akte', 'dp.stat.favDoc': 'Favorisierter Arzt',
  ...
  add('ru', {
    ...
    'dp.stat.upcoming': 'Предстоящая запись', 'dp.stat.unread': 'Непрочитанное сообщение', 'dp.stat.records': 'Медицинская запись', 'dp.stat.favDoc': 'Избранный врач',
  ...
  add('fr', {
    ...
    'dp.stat.upcoming': 'Rendez-vous à venir', 'dp.stat.unread': 'Message non lu', 'dp.stat.records': 'Dossier médical', 'dp.stat.favDoc': 'Médecin favori',
  ...
  add('es', {
    ...
    'dp.stat.upcoming': 'Próxima cita', 'dp.stat.unread': 'Mensaje sin leer', 'dp.stat.records': 'Registro médico', 'dp.stat.favDoc': 'Médico favorito',
  ...
  add('pt', {
    ...
    'dp.stat.upcoming': 'Próxima consulta', 'dp.stat.unread': 'Mensagem não lida', 'dp.stat.records': 'Registro médico', 'dp.stat.favDoc': 'Médico favorito',
  ...
  add('ar', {
    ...
    'dp.stat.upcoming': 'موعد قادم', 'dp.stat.unread': 'رسالة غير مقروءة', 'dp.stat.records': 'سجل طبي', 'dp.stat.favDoc': 'طبيب مفضّل',
  ...
  add('nl', {
    ...
    'dp.stat.upcoming': 'Komende afspraak', 'dp.stat.unread': 'Ongelezen bericht', 'dp.stat.records': 'Medisch dossier', 'dp.stat.favDoc': 'Favoriete arts',

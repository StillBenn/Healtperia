...
(function (I) {
  ...
  /* ===== medical records ===== */
  add('tr', { 'dp.rec.add':'Kayıt Ekle','dp.rec.title':'Başlık','dp.rec.kind':'Tür','dp.rec.date':'Tarih','dp.rec.file':'Dosya','dp.rec.note':'Not','dp.rec.empty':'Henüz tıbbi kaydınız yok. "Kayıt Ekle" ile ekleyebilirsiniz.','dp.rec.k.report':'Rapor','dp.rec.k.prescription':'Reçete','dp.rec.k.image':'Görüntü','dp.rec.k.lab':'Tahlil','dp.rec.k.other':'Diğer' });
  add('en', { 'dp.rec.add':'Add Record','dp.rec.title':'Title','dp.rec.kind':'Type','dp.rec.date':'Date','dp.rec.file':'File','dp.rec.note':'Note','dp.rec.empty':'No medical records yet. Use "Add Record" to create one.','dp.rec.k.report':'Report','dp.rec.k.prescription':'Prescription','dp.rec.k.image':'Image','dp.rec.k.lab':'Lab','dp.rec.k.other':'Other' });
  add('de', { 'dp.rec.add':'Eintrag hinzufügen','dp.rec.title':'Titel','dp.rec.kind':'Typ','dp.rec.date':'Datum','dp.rec.file':'Datei','dp.rec.note':'Notiz','dp.rec.empty':'Noch keine medizinischen Unterlagen.','dp.rec.k.report':'Bericht','dp.rec.k.prescription':'Rezept','dp.rec.k.image':'Bild','dp.rec.k.lab':'Labor','dp.rec.k.other':'Sonstiges' });
  add('ru', { 'dp.rec.add':'Добавить запись','dp.rec.title':'Название','dp.rec.kind':'Тип','dp.rec.date':'Дата','dp.rec.file':'Файл','dp.rec.note':'Заметка','dp.rec.empty':'Записей пока нет.','dp.rec.k.report':'Отчёт','dp.rec.k.prescription':'Рецепт','dp.rec.k.image':'Снимок','dp.rec.k.lab':'Анализ','dp.rec.k.other':'Другое' });
  add('fr', { 'dp.rec.add':'Ajouter un dossier','dp.rec.title':'Titre','dp.rec.kind':'Type','dp.rec.date':'Date','dp.rec.file':'Fichier','dp.rec.note':'Note','dp.rec.empty':'Aucun dossier médical pour le moment.','dp.rec.k.report':'Rapport','dp.rec.k.prescription':'Ordonnance','dp.rec.k.image':'Image','dp.rec.k.lab':'Analyse','dp.rec.k.other':'Autre' });
  add('es', { 'dp.rec.add':'Añadir registro','dp.rec.title':'Título','dp.rec.kind':'Tipo','dp.rec.date':'Fecha','dp.rec.file':'Archivo','dp.rec.note':'Nota','dp.rec.empty':'Aún no hay registros médicos.','dp.rec.k.report':'Informe','dp.rec.k.prescription':'Receta','dp.rec.k.image':'Imagen','dp.rec.k.lab':'Análisis','dp.rec.k.other':'Otro' });
  add('pt', { 'dp.rec.add':'Adicionar registro','dp.rec.title':'Título','dp.rec.kind':'Tipo','dp.rec.date':'Data','dp.rec.file':'Arquivo','dp.rec.note':'Nota','dp.rec.empty':'Ainda não há registros médicos.','dp.rec.k.report':'Relatório','dp.rec.k.prescription':'Receita','dp.rec.k.image':'Imagem','dp.rec.k.lab':'Exame','dp.rec.k.other':'Outro' });
  add('ar', { 'dp.rec.add':'إضافة سجل','dp.rec.title':'العنوان','dp.rec.kind':'النوع','dp.rec.date':'التاريخ','dp.rec.file':'ملف','dp.rec.note':'ملاحظة','dp.rec.empty':'لا توجد سجلات طبية بعد.','dp.rec.k.report':'تقرير','dp.rec.k.prescription':'وصفة','dp.rec.k.image':'صورة','dp.rec.k.lab':'تحليل','dp.rec.k.other':'أخرى' });
  add('nl', { 'dp.rec.add':'Dossier toevoegen','dp.rec.title':'Titel','dp.rec.kind':'Type','dp.rec.date':'Datum','dp.rec.file':'Bestand','dp.rec.note':'Notitie','dp.rec.empty':'Nog geen medische dossiers.','dp.rec.k.report':'Rapport','dp.rec.k.prescription':'Recept','dp.rec.k.image':'Afbeelding','dp.rec.k.lab':'Labo','dp.rec.k.other':'Overig' });
})(window.HP_I18N);
